...
module.exports = (env) => {
    ...
    const platform = env && ((env.android && "android") || (env.ios && "ios")) || "ios";
    if (!platform) {
    ...
    const styleFullpath = resolve(projectRoot, stylePath);

    console.log(`styleFullpath: ${styleFullpath}`);
    const appResourcesFullPath = resolve(projectRoot, appResourcesPath);

    const publicResourcesFullPath = resolve(projectRoot, publicResourcesPath);
    ...
    const config = {
        ...
        plugins: [
            ...
            new CopyWebpackPlugin(
                [{ from: { glob: "fonts/**" } }, { from: { glob: "**/*.jpg" } }, { from: { glob: "**/*.png" } }, { from: { glob: "**/*.svg" } }],
                { ignore: [`${relative(appPath, appResourcesFullPath)}/**`], context: publicResourcesFullPath }
            ),
